                           ...
                           <div class="card-body">
                              ...
                              <form id="myForm" class="forms-sample" method="post" action="/Projeto_Escolar/cadAluno">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nome_aluno" name="nome_aluno" required oninvalid="this.setCustomValidity('Campo requerido')" placeholder="Nome" onchange="try{setCustomValidity('')}catch(e){}"onfocus="this.value='';">
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputPassword4">Data de nascimento</label>
                                    <input id="dataNasc" name="dataNasc" class="form-control input-md" required oninvalid="this.setCustomValidity('Campo requerido')" type="date" onChange="verificaData()" placeholder="MM//dd/YYY" />
                                 </div>
                                 <div class="form-group">
